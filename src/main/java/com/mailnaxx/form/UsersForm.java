...
public class UsersForm {
    ...
    // 氏名(漢字)_姓
    @NotBlank(groups = ValidGroup1.class, message = "氏名(漢字)_姓を入力してください")
    ...
    // 氏名(漢字)_名
    @NotBlank(groups = ValidGroup1.class, message = "氏名(漢字)_名を入力してください")
    @Size(max=10, groups = ValidGroup2.class, message = "全角10文字以内で入力してください")
    @Pattern(regexp="^[^ -~｡-ﾟ]+$", groups = ValidGroup3.class, message = "全角文字で入力してください")
    private String userFirstName;

    // 氏名(カタカナ)_姓
    @NotBlank(groups = ValidGroup1.class, message = "氏名(カタカナ)_姓を入力してください")
    @Size(max=10, groups = ValidGroup2.class, message = "全角10文字以内で入力してください")
    @Pattern(regexp="^[ァ-ー]+$", groups = ValidGroup3.class, message = "全角カナで入力してください")
    private String userLastKana;

    // 氏名(カタカナ)_名
    @NotBlank(groups = ValidGroup1.class, message = "氏名(カタカナ)_名を入力してください")
    @Size(max=10, groups = ValidGroup2.class, message = "全角10文字以内で入力してください")
    @Pattern(regexp="^[ァ-ー]+$", groups = ValidGroup3.class, message = "全角カナで入力してください")
    ...
    // 住所
    @NotBlank(groups = ValidGroup1.class, message = "住所を入力してください")
    @Size(max=256, groups = ValidGroup2.class, message = "全角256文字以内で入力してください")
    @Pattern(regexp="^[^ -~｡-ﾟ]+$", groups = ValidGroup3.class, message = "全角文字で入力してください")
    private String address;

    // 電話番号1
    @NotBlank(groups = ValidGroup1.class, message = "電話番号1を入力してください")
    @Pattern(regexp="^[0-9]+$", groups = ValidGroup2.class, message = "電話番号1は数字5桁以内で入力してください")
    private String phoneNumber1;

    // 電話番号2
    @NotBlank(groups = ValidGroup1.class, message = "電話番号2を入力してください")
    @Pattern(regexp="^[0-9]+$", groups = ValidGroup2.class, message = "電話番号2は数字4桁以内で入力してください")
    private String phoneNumber2;

    // 電話番号3
    @NotBlank(groups = ValidGroup1.class, message = "電話番号3を入力してください")
    @Pattern(regexp="^[0-9]+$", groups = ValidGroup2.class, message = "電話番号3は数字4桁以内で入力してください")
